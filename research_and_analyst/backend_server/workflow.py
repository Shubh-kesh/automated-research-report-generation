...
def build_interview_graph(llm,tavily_search=None):
    ...
    memory = MemorySaver() # To persist interview state across sessions
    ...
    def generation_question(state:InterviewState):
        ...
        """
        analyst = state["analyst"] # the analyst object containing persona and description
        ...
        #return the question appended to messages
    ...
    def search_web(state: InterviewState):
        ...
        Args:
            state (InterviewState): _description_
        """
        # structure to hold search query
...
class AutonomousReportGenerator:
    ...
    def write_introduction(self, state: ResearchGraphState):
        """Generate introduction for the research report
        
        Args:
            state (ResearchGraphState): Current state containing topic and other info
        
        Returns:
            dict: Dictionary containing the generated introduction
        """
        topic = state.get("topic")
        if not topic:
            raise ValueError("Topic cannot be empty when generating introduction")
...
if __name__ == "__main__":
        ...
        # Add input validation for topic
